...
static boolean boyVisited=false;
	int tortoiseSpeed = 5;
	...
	private void spaceBarWasPressed() {
		...
		// 			make a pop-up tell the Tortoise where to go next
	        if(tortoiseLocationX==505&&tortoiseLocationY==295){	
		...
		// (pirate robot, swamp, parrots, etc.)
	        if(tortoiseLocationX==140&&tortoiseLocationY==295&&boyVisited==false){	
				JOptionPane.showMessageDialog(null, "go to the pirate");
				boyVisited=true;
			}
	        if(tortoiseLocationX==415&&tortoiseLocationY==295){	
				JOptionPane.showMessageDialog(null, "go back to the boy");
		
	}
	        if(tortoiseLocationX==140&&tortoiseLocationY==295&&boyVisited==true){	
				JOptionPane.showMessageDialog(null, "go back to the girl");
	        }
